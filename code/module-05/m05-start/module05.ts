...
// let testArray1 = BuildArray.buildArray(12, 'ascending');
// let testArray2 = BuildArray.buildArray(8, 'descending');

let testArray1 = new BuildArray(12, 'ascending').buildArray(12, 'ascending');
let testArray2 = new BuildArray(8, 'descending').buildArray(8, 'descending');
